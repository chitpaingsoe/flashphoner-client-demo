...
},{"./constants":28,"./flash-media-provider":29,"./room-module":31,"./temasys-media-provider":1,"./util":32,"./webrtc-media-provider":33,"./websocket-media-provider":34,"kalmanjs":2,"promise-polyfill":4,"uuid/v1":11,"webrtc-adapter":12}],31:[function(require,module,exports){
'use strict';
        ...
        if (!screenShare) {
          ...
          if (window.chrome && woExtension) {
            getScreenDeviceIdWoExtension(clonedConstraints).then(function (screenSharingConstraints) {
              navigator.mediaDevices.getDisplayMedia(screenSharingConstraints).then(stream => {
...
},{"./constants":28,"./util":32,"uuid/v1":11,"webrtc-adapter":12}],34:[function(require,module,exports){
'use strict';
